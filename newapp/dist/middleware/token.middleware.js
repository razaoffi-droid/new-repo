...
exports.LogTokenMiddleware = void 0;
const common_1 = require("@nestjs/common");
const jwt = __importStar(require("jsonwebtoken"));
const dotenv = __importStar(require("dotenv"));
dotenv.config();
let LogTokenMiddleware = class LogTokenMiddleware {
    use(req, res, next) {
...
exports.LogTokenMiddleware = LogTokenMiddleware;
exports.LogTokenMiddleware = LogTokenMiddleware = __decorate([
